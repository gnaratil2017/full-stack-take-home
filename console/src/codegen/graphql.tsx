...
export type DeleteChatroomNoteMutation = { __typename?: 'Mutation', deleteChatroomNote?: { __typename?: 'DeleteChatroomNotePayload', chatroomNote: { __typename?: 'ChatroomNote', id: string, content: string, createdAt: any, chatroom: { __typename?: 'Chatroom', id: string, label: string, description?: string | null, callerPhoneNumber: string, resolved: boolean, natureCode?: { __typename?: 'NatureCode', id: string, name: string } | null } } } | null };
...
export const DeleteChatroomNoteDocument = gql`
    mutation DeleteChatroomNote($noteId: ID!) {
  deleteChatroomNote(input: {noteId: $noteId}) {
    chatroomNote {
      ...ChatroomNoteData
    }
  }
